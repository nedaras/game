...
//
//    Cmdline:
//        sokol-shdc -i src/shaders/shader.glsl -o src/shaders/shader.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
//    Shader program: 'game':
//        Get shader desc: shd.gameShaderDesc(sg.queryBackend());
//        Vertex Shader: vs
//        Fragment Shader: fs
//        Attributes:
//            ATTR_game_pos => 0
...
//    void main()
//    {
//        gl_Position = vec4((vec4(pos, 1.0) * (mat4(vs_params[0], vs_params[1], vs_params[2], vs_params[3]) * mat4(vs_params[4], vs_params[5], vs_params[6], vs_params[7]))).xyz, 1.0);
//        color = color0;
//    }
//
//
const vs_source_glsl410 = [367]u8 {
    ...
    0x69,0x6f,0x6e,0x20,0x3d,0x20,0x76,0x65,0x63,0x34,0x28,0x28,0x76,0x65,0x63,0x34,
    0x28,0x70,0x6f,0x73,0x2c,0x20,0x31,0x2e,0x30,0x29,0x20,0x2a,0x20,0x28,0x6d,0x61,
    ...
    0x61,0x72,0x61,0x6d,0x73,0x5b,0x37,0x5d,0x29,0x29,0x29,0x2e,0x78,0x79,0x7a,0x2c,
...
//
//
const vs_source_glsl300es = [349]u8 {
    ...
    0x6e,0x20,0x3d,0x20,0x76,0x65,0x63,0x34,0x28,0x28,0x76,0x65,0x63,0x34,0x28,0x70,
    0x6f,0x73,0x2c,0x20,0x31,0x2e,0x30,0x29,0x20,0x2a,0x20,0x28,0x6d,0x61,0x74,0x34,
    ...
    0x61,0x6d,0x73,0x5b,0x37,0x5d,0x29,0x29,0x29,0x2e,0x78,0x79,0x7a,0x2c,0x20,0x31,
...
//    {
//        row_major float4x4 _13_proj_view : packoffset(c0);
...
//    void vert_main()
//    {
//        gl_Position = float4(mul(mul(_13_model, _13_proj_view), float4(pos, 1.0f)).xyz, 1.0f);
//        color = color0;
//    }
//
...
const vs_source_hlsl5 = [834]u8 {
    ...
    0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x78,0x34,0x20,0x5f,0x31,0x33,0x5f,0x70,0x72,
    0x6f,0x6a,0x5f,0x76,0x69,0x65,0x77,0x20,0x3a,0x20,0x70,0x61,0x63,0x6b,0x6f,0x66,
    ...
    0x6c,0x6f,0x61,0x74,0x34,0x28,0x6d,0x75,0x6c,0x28,0x6d,0x75,0x6c,0x28,0x5f,0x31,
    0x33,0x5f,0x6d,0x6f,0x64,0x65,0x6c,0x2c,0x20,0x5f,0x31,0x33,0x5f,0x70,0x72,0x6f,
    0x6a,0x5f,0x76,0x69,0x65,0x77,0x29,0x2c,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x28,
    0x70,0x6f,0x73,0x2c,0x20,0x31,0x2e,0x30,0x66,0x29,0x29,0x2e,0x78,0x79,0x7a,0x2c,
...
//    {
//        main0_out out = {};
//        out.gl_Position = float4((float4(in.pos, 1.0) * (_13.proj_view * _13.model)).xyz, 1.0);
//        out.color = in.color0;
//        return out;
//    }
//
//
const vs_source_metal_macos = [577]u8 {
    ...
    0x6c,0x6f,0x61,0x74,0x34,0x78,0x34,0x20,0x70,0x72,0x6f,0x6a,0x5f,0x76,0x69,0x65,
    ...
    0x74,0x34,0x28,0x28,0x66,0x6c,0x6f,0x61,0x74,0x34,0x28,0x69,0x6e,0x2e,0x70,0x6f,
    0x73,0x2c,0x20,0x31,0x2e,0x30,0x29,0x20,0x2a,0x20,0x28,0x5f,0x31,0x33,0x2e,0x70,
    0x72,0x6f,0x6a,0x5f,0x76,0x69,0x65,0x77,0x20,0x2a,0x20,0x5f,0x31,0x33,0x2e,0x6d,
    0x6f,0x64,0x65,0x6c,0x29,0x29,0x2e,0x78,0x79,0x7a,0x2c,0x20,0x31,0x2e,0x30,0x29,
...
//      var mat : mat4x4f;
//      var out0 : vec4f;
//      let x_18 : mat4x4f = x_13.proj_view;
//      let x_21 : mat4x4f = x_13.model;
//      mat = (x_18 * x_21);
//      let x_28 : vec3f = pos;
//      let x_34 : mat4x4f = mat;
//      out0 = (vec4f(x_28.x, x_28.y, x_28.z, 1.0f) * x_34);
//      let x_42 : vec4f = out0;
//      let x_43 : vec3f = vec3f(x_42.x, x_42.y, x_42.z);
//      gl_Position = vec4f(x_43.x, x_43.y, x_43.z, 1.0f);
//      let x_53 : vec4f = color0;
//      color = x_53;
//      return;
//    }
//
...
//
//    @vertex
//    fn main(@location(0) pos_param : vec3f, @location(1) color0_param : vec4f) -> main_out {
//      pos = pos_param;
//      color0 = color0_param;
//      main_1();
...
const vs_source_wgsl = [1065]u8 {
    ...
    0x20,0x70,0x72,0x6f,0x6a,0x5f,0x76,0x69,0x65,0x77,0x20,0x3a,0x20,0x6d,0x61,0x74,
    0x34,0x78,0x34,0x66,0x2c,0x0a,0x20,0x20,0x2f,0x2a,0x20,0x40,0x6f,0x66,0x66,0x73,
    0x65,0x74,0x28,0x36,0x34,0x29,0x20,0x2a,0x2f,0x0a,0x20,0x20,0x6d,0x6f,0x64,0x65,
    0x6c,0x20,0x3a,0x20,0x6d,0x61,0x74,0x34,0x78,0x34,0x66,0x2c,0x0a,0x7d,0x0a,0x0a,
    ...
    0x65,0x3e,0x20,0x70,0x6f,0x73,0x20,0x3a,0x20,0x76,0x65,0x63,0x33,0x66,0x3b,0x0a,
    ...
    ,
...
pub fn gameShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    var desc: sg.ShaderDesc = .{};
    desc.label = "game_shader";
    switch (backend) {
        .GLCORE => {
...
pub fn gameAttrSlot(attr_name: []const u8) ?usize {
...
pub fn gameImageSlot(img_name: []const u8) ?usize {
    _ = img_name;
    return null;
}
pub fn gameSamplerSlot(smp_name: []const u8) ?usize {
    _ = smp_name;
    return null;
}
pub fn gameUniformblockSlot(ub_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        return 0;
    }
    return null;
}
pub fn gameUniformblockSize(ub_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        return @sizeOf(VsParams);
    }
    return null;
}
pub fn gameUniformOffset(ub_name: []const u8, u_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        if (std.mem.eql(u8, u_name, "proj_view")) {
            return 0;
        }
...
pub fn gameUniformDesc(ub_name: []const u8, u_name: []const u8) ?sg.GlslShaderUniform {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        if (std.mem.eql(u8, u_name, "proj_view")) {
            var desc: sg.GlslShaderUniform = .{};
            desc.type = .MAT4;
            desc.array_count = 0;
            desc.glsl_name = "proj_view";
            return desc;
        }
        if (std.mem.eql(u8, u_name, "model")) {
            var desc: sg.GlslShaderUniform = .{};
...
pub fn gameStoragebufferSlot(sbuf_name: []const u8) ?usize {
    _ = sbuf_name;
    return null;
}
